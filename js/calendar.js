...
/* --- last modification: 1st November 2007 by Deliana Kostadinova
By Oliver Bryant
...
Modified by Pascal Hennig - added german as second language; 
			made script flexible, so you can use parameters to disable or allow the Past.
			Just call lcs(this, true) to disable the Past.
			Choose between Monday and Sunday as your starting day.
Modified by Deliana Kostadinova - added bulgarian language; changed the encoding to UTF.
*/
...
var language	= 'bg';			// de = German; en = English; bg = Bulgarian
...
document.write('<tr><td align=center style="background:#ABABAB;font:12px Arial">M</td><td align=center style="background:#ABABAB;font:12px Arial">T</td><td align=center style="background:#ABABAB;font:12px Arial">W</td><td align=center style="background:#ABABAB;font:12px Arial">T</td><td align=center style="background:#ABABAB;font:12px Arial">F</td><td align=center style="background:#ABABAB;font:12px Arial">S</td><td align=center style="background:#ABABAB;font:12px Arial">S</td></tr>');
		...
		document.write('<table id="fc" style="position:absolute;top:356px;left:380px;border-collapse:collapse;background:#FFFFFF;border:1px solid #ABABAB;display:none" cellpadding=2><tr><td style="cursor:pointer" onclick="csubm()">&laquo;&laquo;</td><td colspan=5 id="mns" align="center" style="font:bold 13px Arial"></td><td align="right" style="cursor:pointer" onclick="caddm()">&raquo;&raquo;</td></tr><tr><td align=center style="background:#ABABAB;font:12px Arial">пн</td><td align=center style="background:#ABABAB;font:12px Arial">вт</td><td align=center style="background:#ABABAB;font:12px Arial">ср</td><td align=center style="background:#ABABAB;font:12px Arial">чт</td><td align=center style="background:#ABABAB;font:12px Arial">пт</td><td align=center style="background:#ABABAB;font:12px Arial">сб</td><td align=center style="background:#ABABAB;font:12px Arial">нд</td></tr>');
	}
...
if( language == 'en' )
	...
	var mn=new Array('ЯНУ','ФЕВ','МАР','АПР','МАЙ','ЮНИ','ЮЛИ','АВГ','СЕП','ОКТ','НОЕ','ДЕК');
