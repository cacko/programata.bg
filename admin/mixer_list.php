...
$aSectionPages = $oPage->ListAllParentsAsArraySimple(null, '', 'publication_list', true);
//=========================================================
...
//=========================================================
	...
	$rs = $oPublication->ListAll(getRequestArg('parent_page',null), getRequestArg('keyword'),
...
<?
		...
		while ($row = mysql_fetch_object($rs))
		{
			if ($curRow >= $nStartRow && $curRow < $nEndRow)
			{
				...
				$sMainImageFile = '../'.UPLOAD_DIR.IMG_PUBLICATION_THUMB.$row->PublicationID.'.'.EXT_IMG;
