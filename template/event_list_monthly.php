...
<!--ul class="inline_nav"-->
	...
	<!--li class="next<?=IIF($cat==3, ' on', '')?>"><a href="<?=setPage($page, 3, $item)?>"><?=getLabel('strNextMonth')?></a></li-->
	<!--li class="this<?=IIF($cat==2, ' on', '')?>"><a href="<?=setPage($page, 2, $item)?>"><?=getLabel('strThisWeek')?></a></li-->
